...
//Part1.2
// const months = ["1", "5", "7", "8", "10", "14", "21"];

// const random = Math.floor(Math.random() * months.length);
// console.log(random,months[random]);
//console.log('Tra ve gia tri index trong mang')
//console.log('Math.floor đi cùng vs Math.random để tra ve gia tri số nguyên')

//Part1.3
// const Questions=[
//     {
//       name: 'what sweet food made by bees',
//       answer: ['Bread', 'Honey','Sugar','Potent'],
//   },
//   {
//       name: 'what animals can fly',    
//       answer: ['Hyena', 'Bird','Fish','Lion'],
//   },
//   {
//       name: 'How many legs does spiders has',    
//       answer: ['4legs', '2legs','8legs','2legs'],
//   },
// ]
//Part1.4
// const Questions=[
//     {
//       name: 'what sweet food made by bees',
//       answer: ['1.Bread', '2.Honey','3.Sugar','4.Potent'],
//   },
//   {
//       name: 'what animals can fly',    
//       answer: ['1.Hyena', '2.Bird','3.Fish','4.Lion'],
//   },
//   {
//       name: 'How many legs does spiders has',    
//       answer: ['1.4legs', '2.2legs','3.8legs','4.2legs'],
//   },
// ]
// const random = Math.floor(Math.random() * Questions.length);
// let a=prompt(` ${Questions[random].name}
// ${Questions[random].answer}`);
//Part1.5
// const Questions=[
//     {
//       name: 'what sweet food made by bees',
...
// let a=prompt(` ${Questions[random].name}
// ${Questions[random].answer}`);
// if(Questions[random].answer[(a-1)] == '3.8legs' || Questions[random].answer[(a-1)] == '2.Bird' || Questions[random].answer[(a-1)] == '2.Honey')
// {
//   alert('Bravo!!!')
// }
// else
...
// {
// let a=prompt(` ${Questions[i].name}
// ${Questions[i].answer}`);
// if (Questions[i].answer[(a-1)] == '3.8legs' || Questions[i].answer[(a-1)] == '2.Bird' || Questions[i].answer[(a-1)] == '2.Honey')
// {
// alert('Bravo!!!')
...
// }
// }
// alert('sr we run out of question :((( ')
...
// }
// alert('sr we run out of question :((( ')
// alert("You answered correectly "+point+' out of 3')
...
//2.4
// console.log("First job jobTitle:")
...
//2.8 em có tham khảo qua bài của Bạn Công
// for(i=0;i<6;i++)
// {
// console.log(jobData.hits[i]._highlightResult.jobTitle.value);
...
//3.1
//   const Array=['to', 'be', 'that', 'of', 'elon', 'to', 'this', 'now', 'back', 'cool', 'hey', 'love', 'of', 'life', 'that', 'rain', 'summer', 'color', 'now', 'of', 'hat', 'late', 'sorry', 'my', 'team'];
// const countData ={};
...
//     },]
    ...
    // console.log(Countbrand[x])
    // alert ('There are '+Countbrand[x]+" of "+x+" in inventory")
...
// {
// const inventor =inventory[t];
// //console.log(inventor);
// const brand = inventor.brand;
// //console.log(brand)
// brandByGroup[brand].push(inventor.name)
// }
// for(let i=0;i<inventory.length;i++)
//   if(inventory[i].brand=='Dell')
//     {
...
// //console.log(brand)
//  brandByGroup[brand].push(inventor.name)
// priceByGroup[brand].push(inventor.price)
// quantityByGroup[brand].push(inventor.quantity)
// }
// for(let i=0;i<inventory.length;i++)
//   if(inventory[i].brand=='Dell')
//     {
...
//       Countbrand.Asus++;
//     }
// // console.log(priceByGroup)
//  let x=prompt('Which brand')
// if(x=='HP'){
// let A=(priceByGroup.HP[0]*quantityByGroup.HP[0]+priceByGroup.HP[1]*quantityByGroup.HP[1])
// alert (`There are  ${Countbrand[x]} of  ${x}  in inventory
//  ${brandByGroup[x]} 
//  total value ${A}`) 
// }
// else if(x=='Asus'){
//  let A=(priceByGroup.Asus[0]*quantityByGroup.Asus[0])
// alert (`There are  ${Countbrand[x]} of  ${x}  in inventory
//  ${brandByGroup[x]} 
//  total value ${A}`) 
//  }
// else 
//  {
//  let A=(priceByGroup.Dell[0]*quantityByGroup.Dell[0]+priceByGroup.Dell[1]*quantityByGroup.Dell[1]+priceByGroup.Dell[2]*quantityByGroup.Dell[2])
//  alert (`There are  ${Countbrand[x]} of  ${x}  in inventory
//  ${brandByGroup[x]} 
//  total value ${A}`) 
//  }
